...
{
    public class FaucetFreeLTCFunController2 : BaseController
    {
        private readonly IFaucetFreeLTCFunService2 faucetFreeLTCFunService;
        private readonly ILogger<FaucetFreeLTCFunController2> logger;

        public FaucetFreeLTCFunController2(IFaucetFreeLTCFunService2 faucetFreeLTCFunService,
            ILogger<FaucetFreeLTCFunController2> logger
            )
        {
